...
const data = {
  ...
  description:
    "Мы делаем дорогие и роскошные 💐букеты для любого 🎉случая c быстой доставкой по Калининграду и области. У нас только лучшие цветы и материалы, любовь и красота в каждом букете.",
