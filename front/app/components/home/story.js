  ...
  return (
    <div className="story">
      ...
      <div className="wrapp container">
        ...
        <p className="text">
<<<<<<< HEAD
          Каждый человек уникален, как и каждый момент нашей жизни. Понимая эту
          простую истину мы делаем &nbsp;
          <b>цветочные букеты</b>, которые должны соответствовать случаю. Ведь
...
>>>>>>> 9548a1b335ecaa0395417ddafbe5f92213e83e5f
        </p>
      </div>
    </div>
  );
